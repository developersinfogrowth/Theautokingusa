import { CALIFORNIA_FEATURES } from '../lib/commercial.constants';

export default function WhyChooseCalifornia() {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10 sm:mb-14">
          ...
          <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Trusted by fleets, owner-operators, and repair shops across California
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {CALIFORNIA_FEATURES.map((feature, index) => {
